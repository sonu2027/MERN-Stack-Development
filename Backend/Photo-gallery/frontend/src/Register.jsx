              ...
              status ?
                ...
                <div className='bg-white rounded-md border-2 border-solid border-slate-300 px-4 py-6'>
                  ...
                  <form onSubmit={handleSubmit} encType='multipart/form-data'>
                    ...
                    <input className='border-2 solid border-gray-300 rounded-sm w-64 sm:w-72 bg-gray-100 px-1 py-1 focus:outline-blue-500 mb-6' type="password" name='password' placeholder='Enter Password' /><br />

                    <label className='text-gray-500 rounded-md bg-gray-200 px-3 py-2 hover:cursor-pointer' htmlFor="image">Upload profile photo </label><br />
                    <input className='w-64 sm:w-72 hidden' type="file" name="image"  id="image" /><br />
